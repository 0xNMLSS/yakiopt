...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-orange-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 flex flex-col items-center justify-center px-6 py-12 relative overflow-hidden transition-colors duration-500">
      ...
      <div className="text-center max-w-3xl relative z-10 glass dark:bg-slate-900/60 dark:border-slate-800 rounded-3xl p-10 md:p-16 transition-colors duration-300">
        ...
        <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-400 mb-12 leading-relaxed font-medium">
          The mathematical solution to the "All-You-Can-Eat" yakiniku fatigue problem. Eat smarter, not just harder.
        </p>
        
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
          <Link 
            to="/planner" 
            className="group relative w-full sm:w-auto px-10 py-5 bg-gradient-to-r from-red-600 to-orange-500 text-white font-black text-lg rounded-2xl shadow-xl shadow-red-500/30 transition-all hover:shadow-red-500/50 hover:-translate-y-1 hover:scale-[1.02] active:scale-95 overflow-hidden"
          >
            <span className="relative z-10">Calculate My Strategy</span>
          ...
          <Link 
            to="/paper" 
            className="w-full sm:w-auto px-10 py-5 bg-white dark:bg-slate-800 text-gray-700 dark:text-gray-200 font-bold text-lg rounded-2xl border border-gray-200 dark:border-slate-700 shadow-sm hover:shadow-md hover:bg-gray-50 dark:hover:bg-slate-700 transition-all active:scale-95"
          >
            Read the Paper
          </Link>
        </div>
        ...
        <div className="mt-16 pt-8 border-t border-gray-100 dark:border-slate-800">
          <p className="text-sm font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest">
            Based on the <span className="text-red-500 dark:text-red-400 mx-1">κ</span> Engineering Specification
          </p>
        </div>
      </div>
    </div>
