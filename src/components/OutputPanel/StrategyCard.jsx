      ...
      <div className="ml-2">
        ...
        <div className="space-y-3">
          <div className="flex flex-wrap items-center gap-2">
            <span className="text-[11px] font-bold uppercase tracking-wider text-[var(--text-muted)] w-14">Focus</span>
            <span className="px-3 py-1 bg-gray-100 dark:bg-slate-700/50 text-[var(--text-main)] rounded-lg text-sm font-semibold border border-gray-100 dark:border-slate-700">{phase.label}</span>
          </div>
          
          <div className="flex flex-col sm:flex-row sm:items-center gap-2">
            <span className="text-[11px] font-bold uppercase tracking-wider text-[var(--text-muted)] w-14 shrink-0">Order</span>
          ...
          {phase.kimchiFreq && (
            <div className="flex flex-wrap items-center gap-2 mt-2">
              <span className="text-[11px] font-bold uppercase tracking-wider text-green-500 dark:text-green-400 w-14">Kimchi</span>
          ...
          {phase.avoid && phase.avoid.length > 0 && (
            <div className="flex flex-wrap items-center gap-2 mt-2">
              <span className="text-[11px] font-bold uppercase tracking-wider text-rose-400 dark:text-rose-300 w-14">Avoid</span>
              <div className="flex flex-wrap gap-1.5">
