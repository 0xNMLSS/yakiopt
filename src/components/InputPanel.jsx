...
export default function InputPanel() {
  ...
  return (
    <div className="glass dark:bg-slate-900/40 dark:border-slate-800 rounded-3xl p-6 sm:p-8 space-y-8 relative overflow-hidden transition-colors duration-300">
      ...
      <div>
        <h2 className="text-2xl font-extrabold text-[var(--text-main)] tracking-tight">Session Settings</h2>
        <p className="text-sm text-[var(--text-muted)] mt-1 pb-4 border-b border-gray-100 dark:border-slate-800">Dial in your yakiniku parameters to generate the perfect strategy.</p>
      </div>
      ...
      <div className="space-y-5">
        ...
        <div className="space-y-4">
          <div className="group">
            <label className="block text-sm font-semibold text-[var(--text-main)] mb-1.5 transition-colors group-focus-within:text-red-600 dark:group-focus-within:text-red-400">Grill Speed</label>
            <select
          ...
          <div className="group">
            <label className="block text-sm font-semibold text-[var(--text-main)] mb-1.5 transition-colors group-focus-within:text-red-600 dark:group-focus-within:text-red-400">Serve Delay</label>
            <select
          ...
          <div className="group">
            <label className="block text-sm font-semibold text-[var(--text-main)] mb-1.5 transition-colors group-focus-within:text-red-600 dark:group-focus-within:text-red-400">Time Limit (minutes)</label>
          ...
          <div className="group">
            <div className="flex justify-between items-center mb-1.5">
              <label className="block text-sm font-semibold text-[var(--text-main)] transition-colors group-focus-within:text-red-600 dark:group-focus-within:text-red-400">Fatty Meat Ratio</label>
      ...
      <div className="space-y-5 pt-2">
        ...
        <div className="space-y-4">
          <div className="group">
            <label className="block text-sm font-semibold text-[var(--text-main)] mb-1.5 transition-colors group-focus-within:text-orange-500">Appetite Level</label>
            <select
          ...
          <div className="group">
            <label className="block text-sm font-semibold text-[var(--text-main)] mb-1.5 transition-colors group-focus-within:text-orange-500">Fatigue Sensitivity</label>
            <select
          ...
          <div className="group">
            <label className="block text-sm font-semibold text-[var(--text-main)] mb-1.5 transition-colors group-focus-within:text-orange-500">Eating Speed</label>
            <select
          ...
          <div className="group">
            <label className="block text-sm font-semibold text-[var(--text-main)] mb-1.5 transition-colors group-focus-within:text-orange-500">Group Size</label>
            <div className="relative">
              <input
                type="number"
